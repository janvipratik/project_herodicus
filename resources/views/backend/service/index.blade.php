    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <table id="ServiceDatatable" class="table table-bordered text-nowrap" style="width:100%">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Name</th>
...
@section('js')
    <script type="text/javascript">
        (function(window, jQuery) {
            ...
            window.LaravelDataTables["ServiceDatatable"] = jQuery("#ServiceDatatable").DataTable({
                "serverSide": true,
                // "processing": true,
                "pageLength": 10,
                "ajax": {
        ...
        jQuery('.datatable-form-filter input').on('keyup', function(e) {
            window.LaravelDataTables["ServiceDatatable"].draw();
            e.preventDefault();
        });
